...
public final class AdminDtos {
 ...
 public record SettlementView(Long id,Long reservationId,Long paymentId,Long cleanerId,Long grossCents,Long platformFeeCents,Long providerAmountCents,String currency,String stripePaymentIntentId,String stripeChargeId,String stripeTransferId,String stripeApplicationFeeId,String status){}
 public record ReservationTimeline(Long reservationId,String reservationStatus,Long paymentId,String paymentStatus,List<TimelineItem> events,SettlementView settlement){}
}
